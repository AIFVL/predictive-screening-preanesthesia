...
def validate_based_on_liquidos(df: pd.DataFrame) -> pd.DataFrame:
    ...
    # Flag agregado
    liquidos_flags = [
        'flag_hemoderivados', 'flag_aferesis', 'flag_volumen_alto',
